...
export const PricePlan = () => {
  ...
  return (
    ...
    className= "flex flex-col w-full items-center gap-12 pt-10 pb-6 px-0 absolute top-[7780px] left-0" 
...
<div
    ...
    className= "flex w-[363px] items-center gap-10 flex-col relative flex-[0_0_auto]" 
...
<div
    ...
    className= "inline-flex flex-col items-start gap-10 relative flex-[0_0_auto]" 
...
<div
    ...
    className= "relative w-[363px] h-[1597px]" 
...
<div
    ...
    className= "flex flex-col w-[265px] items-center gap-4 relative flex-[0_0_auto]" 
...
<img
    ...
    className= "relative w-[211px] h-[281px] aspect-[0.75] object-cover" 
...
<div
    ...
    className= "flex w-[74px] items-start flex-col relative flex-[0_0_auto]" 
...
<div
    ...
    className= "relative self-stretch mt-[-1.00px] [font-family:'Noto_Sans_JP',Helvetica] font-medium text-[var(--)] text-2xl text-center tracking-[0] leading-9" 
...
<div
    ...
    className= "relative self-stretch -mt-0.5 [font-family:'Noto_Sans_JP',Helvetica] font-medium text-[var(--)] text-base text-center tracking-[0] leading-9" 
...
<div
    ...
    className= "flex flex-col w-36 items-center relative flex-[0_0_auto]" 
...
<div
    ...
    className= "relative w-fit mt-[-1.00px] [font-family:'Noto_Sans_JP',Helvetica] font-medium text-[var(--)] text-base text-center tracking-[0] leading-[normal]" 
...
<div
    ...
    className= "relative w-fit mt-[-1.00px] [font-family:'Noto_Sans_JP',Helvetica] font-medium text-[var(--)] text-base tracking-[0] leading-[normal]" 
...
<p
    ...
    className= "relative w-fit [font-family:'Noto_Sans_JP',Helvetica] font-bold text-[var(--)] text-[32px] text-center tracking-[0] leading-[normal]" 
...
<div
    ...
    className= "relative w-[363px] h-[1616px]" 
...
<div
    ...
    className= "flex items-center gap-3 self-stretch w-full flex-col relative flex-[0_0_auto]" 
...
<div
    ...
    className= "relative self-stretch mt-[-1.00px] [font-family:'Noto_Sans_JP',Helvetica] font-medium text-[var(--)] text-base text-center tracking-[0] leading-[21.6px]" 
...
<div
    ...
    className= "relative w-fit mt-[-1.00px] [font-family:'Noto_Sans_JP',Helvetica] font-medium text-[var(--)] text-base tracking-[0] leading-[21.6px] whitespace-nowrap" 
...
<p
    ...
    className= "relative w-fit [font-family:'Noto_Sans_JP',Helvetica] font-normal text-[var(--)] text-[32px] text-center tracking-[0] leading-[44.2px]" 
...
<span
    ...
    className= "font-bold text-[#efa3af] text-2xl leading-[33.1px]" 
...
<BtnSp
        ...
        className="!mr-[-2.00px] !flex-[0_0_auto] !left-[unset] !top-[unset]"  
...
<div
    ...
    className= "inline-flex flex-col items-start gap-10 relative flex-[0_0_auto] ml-[-1.00px] mr-[-1.00px]" 
...
<div
    ...
    className= "flex flex-col w-[265px] items-center gap-10 relative flex-[0_0_auto]" 
...
<div
    ...
    className= "absolute top-[157px] left-2 w-[196px] h-2.5 bg-[#d9d9d9] rounded-[98px/5px] blur-[4.5px]" 
...
<img
    ...
    className= "absolute top-[98px] left-2 w-[196px] h-16 aspect-[3.07] object-cover" 
...
<div
    ...
    className= "self-stretch text-[var(--)] text-base leading-9 relative [font-family:'Noto_Sans_JP',Helvetica] font-medium text-center tracking-[0]" 
...
<div
    ...
    className= "relative w-[212.5px] h-[281px]" 
...
<div
    ...
    className= "absolute top-[165px] left-2 w-[196px] h-2.5 bg-[#d9d9d9] rounded-[98px/5px] blur-[4.5px]" 
...
<img
    ...
    className= "absolute top-[78px] left-0 w-[212px] h-[125px] aspect-[1.7]" 
...
<img
    ...
    className= "absolute top-[29px] left-0 w-[211px] h-56 aspect-[0.94]" 
...
<div
    ...
    className= "flex flex-col items-center gap-[5px] relative self-stretch w-full flex-[0_0_auto]" 
...
<div
    ...
    className= "relative w-fit mt-[-1.00px] [font-family:'Noto_Serif',Helvetica] font-bold text-[var(--)] text-2xl text-center tracking-[0] leading-9 whitespace-nowrap" 
...
<p
    ...
    className= "relative self-stretch [font-family:'Noto_Sans_JP',Helvetica] font-normal text-[var(--)] text-sm tracking-[0] leading-[26px]" 
...
>
{" "}ピル：18歳未満、45歳以上は不可、過去にアレルギー反応があった方、BMI30以上や喫煙、既往歴で血栓症のリスクがあった場合は医師の判断で処方不可となる場合があります<br/> 肌：妊娠中、授乳中の方は一部使用できない薬があります
</span>
</p>
</div>
</div>
