...
export const CtaWrapper = () => {
  return (
    <div className="hidden md:flex flex-col w-full items-center gap-6 md:gap-10 px-4 md:px-[174px] py-6 md:py-10 relative z-20 bg-[#E5BCC5]">
      <div className="flex flex-col items-start gap-4 md:gap-6 relative self-stretch w-full flex-[0_0_auto]">
        ...
        <div className="flex flex-row items-center justify-center gap-2 md:gap-[39px] relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-1 md:w-[270px] h-[45px] md:h-[65px] items-center justify-center gap-2.5 px-2 md:px-[51px] py-2 md:py-2.5 relative bg-white rounded-[10px]">
            <div className="relative w-fit [font-family:'Noto_Sans_JP',Helvetica] font-semibold text-[#E5BCC5] text-sm md:text-2xl text-center tracking-[1.20px] leading-[normal] whitespace-nowrap">
              診察料0円
            </div>
          </div>

          <div className="flex flex-1 md:w-[270px] h-[45px] md:h-[65px] items-center justify-center gap-2.5 px-2 md:px-[51px] py-2 md:py-2.5 relative bg-white rounded-[10px]">
            <div className="w-fit [font-family:'Noto_Sans_JP',Helvetica] font-semibold text-[#E5BCC5] text-sm md:text-2xl tracking-[1.20px] relative text-center leading-[normal] whitespace-nowrap">
              いつでも診察可能
            </div>
          </div>
