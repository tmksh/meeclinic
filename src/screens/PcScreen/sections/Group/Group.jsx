...
export const Group = () => {
  return (
    <div className="relative w-full max-w-[1446px] mx-auto h-auto mt-12 md:mt-20 z-10 pb-16 md:pb-0">
      <div className="absolute top-0 left-0 w-full h-full md:top-[90px] md:left-0 md:w-full md:h-[850px] bg-[#f5ebe6] -z-10" />
      ...
      <div className="flex flex-col w-full items-center md:block relative">
        ...
        {/* Description */}
        <div className="relative md:ml-[299px] md:mt-[144px] w-full md:w-[417px] px-4 md:px-0 mt-8 [font-family:'Noto_Serif_JP',Helvetica] font-medium text-[var(--)] text-base md:text-xl text-justify tracking-[0] leading-[1.6] md:leading-[normal]">
        ...
        <div className="flex flex-col md:block w-full items-center gap-8 mt-8 px-4">
          {/* Image */}
          <div className="relative w-[175px] h-[190px] mx-auto md:mx-0 md:absolute md:top-[381px] md:left-[104px]">
          ...
          <div className="flex flex-row justify-center gap-4 w-full md:contents">
            {/* Stats 1 */}
            <div className="flex flex-col w-[160px] md:w-[242px] items-center gap-5 relative mx-auto md:mx-0 md:absolute md:top-[381px] md:left-[764px]">
            ...
            {/* Stats 2 */}
            <div className="flex flex-col w-[160px] md:w-[242px] items-center gap-5 relative mx-auto md:mx-0 md:absolute md:top-[381px] md:left-[1018px]">
              <p className="mt-[-1.00px] [font-family:'Inter',Helvetica] font-normal text-[var(--)] text-[24px] md:text-[32px] relative w-fit tracking-[0] leading-[normal]">
        ...
        {/* Tags */}
        <div className="flex flex-wrap justify-center w-full md:w-[528px] items-center gap-[16px_16px] relative mt-8 mb-12 px-4 md:absolute md:top-[632px] md:left-[104px] md:mt-0 md:mb-0 md:px-0">
