...
export const Frame = () => {
  return (
    <div className="flex flex-col w-full md:w-[1440px] items-center gap-8 md:gap-16 px-4 md:px-0 py-16 relative md:absolute md:top-[16407px] md:left-0 z-40">
      ...
      <div className="flex flex-col w-full md:w-[896px] items-center gap-10 relative flex-[0_0_auto]">
        ...
        <div className="flex flex-col w-full md:w-[896px] items-center justify-center gap-2.5 px-4 md:px-20 py-8 md:py-[45px] relative flex-[0_0_auto] bg-[var(--)] rounded-[20px] md:rounded-[40px]">
          <div className="inline-flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 relative flex-[0_0_auto]">
            ...
            <div className="flex flex-col w-full md:w-[354px] items-center md:items-start gap-6 relative">
              <div className="flex flex-col w-full md:w-32 items-center md:items-start gap-3 relative flex-[0_0_auto]">
                <div className="relative self-stretch mt-[-1.00px] [font-family:'Noto_Sans_JP',Helvetica] font-medium text-[var(--)] text-2xl md:text-[32px] tracking-[0] leading-[normal] text-center md:text-left">
                  迫　美樹
                </div>

                <div className="relative self-stretch [font-family:'Noto_Sans_JP',Helvetica] font-medium text-[var(--)] text-lg md:text-xl tracking-[0] leading-[normal] text-center md:text-left">
                  院長
                </div>
              </div>

              <div className="relative self-stretch [font-family:'Noto_Sans_JP',Helvetica] font-normal text-[var(--)] text-sm md:text-base tracking-[0.80px] leading-[1.8] md:leading-[28.8px] text-justify">
