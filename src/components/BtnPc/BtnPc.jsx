...
export const BtnPc = ({ className }) => {
  return (
    ...
    >
      ...
      <div className="relative w-[30px] h-[30px] md:w-6 md:h-6 xl:w-[30px] xl:h-[30px] bg-white rounded-[15px]">
        <img
          className="absolute top-[7px] md:top-[5px] xl:top-[7px] left-2.5 md:left-2 xl:left-2.5 w-3.5 h-[17px] md:w-3 md:h-[14px] xl:w-3.5 xl:h-[17px]"
          alt="Vector"
