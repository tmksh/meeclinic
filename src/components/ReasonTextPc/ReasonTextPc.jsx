...
export const ReasonTextPc = ({
  ...
  return (
    ...
    >
      <div className="relative self-stretch mt-[-1.00px] [font-family:'Noto_Serif',Helvetica] font-normal text-[#C2B5B5] text-[60px] md:text-[80px] xl:text-[100px] tracking-[3.00px] md:tracking-[4.00px] xl:tracking-[5.00px] leading-[60px] md:leading-[80px] xl:leading-[100px]">
        {prop}
      </div>
      <div
